...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-3AHIJOH\\MSSQLSERVERDH; DataBase=DBVENTA;Integrated Security=true; Encrypt=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Categorium>(entity =>
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CEF2633E4");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F194446B4");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF48359218EF7");
        ...
        {
            entity.HasKey(e => e.IdNegocio).HasName("PK__Negocio__70E1E107798368A6");
        ...
        {
            entity.HasKey(e => e.IdNumeroCorrelativo).HasName("PK__NumeroCo__25FB547EF6664A86");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A132CA878A46");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F76B7DD4853");
        ...
        {
            entity.HasKey(e => e.IdRolMenu).HasName("PK__RolMenu__CD2045D8C06E7A0D");
        ...
        {
            entity.HasKey(e => e.IdTipoDocumentoVenta).HasName("PK__TipoDocu__A9D59AEEBE4AB6F9");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A69C473DAF");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D561415270AAE");
